...
class PsController extends BaseController
{
    ...
    public function groupSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '配送站设置',
                'url' => $id ? U('Multi/Ps/groupSet', array('id' => $id)) : U('Multi/Ps/groupSet')
            )
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function xqSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '小区设置',
                'url' => $id ? U('Multi/Ps/xqSet', array('id' => $id)) : U('Multi/Ps/xqSet')
            )
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
