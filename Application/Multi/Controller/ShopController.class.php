...
class ShopController extends BaseController
{
    ...
    public function set()
    {
        ...
        $m = M('Shop_set');
        $map['id'] = session("homeShopId");
        //设置面包导航，主加载器请配置
        $bread = array(
            '0' => array(
                'name' => '商城设置',
                'url' => U('Multi/Shop/set'),
            ),
        );
    ...
    public function goodsSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '商品设置',
                'url' => $id ? U('Multi/Shop/goodsSet', array('id' => $id)) : U('Multi/Md/mdSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function cateSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '分类设置',
                'url' => $id ? U('Multi/Shop/cateSet', array('id' => $id)) : U('Multi/Shop/cateSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
        if (IS_POST) {
            ...
            if ($id) {
                ...
                if ($re) {
                    ...
                    //更新Indexgroup
                    $Indexgroup = setIndexgroup(session("homeShopId"));
    ...
    public function groupSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '分组设置',
                'url' => $id ? U('Multi/Shop/groupSet', array('id' => $id)) : U('Multi/Shop/groupSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function skuattrSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => 'SKU属性设置',
                'url' => $id ? U('Multi/Shop/skuattrSet', array('id' => $id)) : U('Multi/Shop/skuattrSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function sku()
    {
        ...
        $bread = array(
            ...
            '1' => array(
                'name' => '商品SKU管理',
                'url' => U('Multi/Shop/skuattr', array('id' => $_GET['id'])),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        $goodsid = I('id');
    ...
    public function skuSet()
    {
        ...
        $bread = array(
            ...
            '1' => array(
                'name' => '商品SKU管理',
                'url' => U('Multi/Shop/sku', array('id' => $cache['goodsid'])),
            ),
            '2' => array(
                'name' => '商品SKU设置',
                'url' => U('Multi/Shop/skuSet', array('id' => $id)),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function adsSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '广告设置',
                'url' => $id ? U('Multi/Shop/adsSet', array('id' => $id)) : U('Multi/Shop/adsSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function orderReport()
    {
        ...
        $morder = D('shop_order');
        $map['shop_id'] = session("homeShopId");
        $data = $morder->today($map);

        $goods = array();
        $sku = array();
        $temp = $mgoods->where($map)->select();
        foreach ($temp as $k => $v) {
            $goods[$v['id']] = $v;
        }
        $temp = $msku->select();
    ...
    public function orderDetail()
    {
        ...
        $bread = array(
            ...
            '1' => array(
                'name' => '商城订单',
                'url' => U('Multi/Shop/order'),
            ),
            '2' => array(
                'name' => '订单详情',
                'url' => $id ? U('Multi/Shop/orderDetail', array('id' => $id)) : U('Multi/Shop/orderDetail'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        $cache = $m->where('id=' . $id)->find();
    ...
    public function labelSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '标签设置',
                'url' => $id ? U('Multi/Shop/lebelSet', array('id' => $id)) : U('Multi/Shop/lebelSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
