...
class MdController extends BaseController
{
    ...
    public function groupSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '分组设置',
                'url' => $id ? U('Multi/Md/groupSet', array('id' => $id)) : U('Multi/Md/groupSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
    ...
    public function mdSet()
    {
        ...
        $bread = array(
            ...
            '2' => array(
                'name' => '门店设置',
                'url' => $id ? U('Multi/Md/mdSet', array('id' => $id)) : U('Multi/Md/mdSet'),
            ),
        );
        $this->assign('breadhtml', $this->getBread($bread));
        //处理POST提交
