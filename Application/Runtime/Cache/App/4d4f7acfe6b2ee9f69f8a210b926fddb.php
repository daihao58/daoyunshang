...
<head>
    ...
    <link href="/Addons/Apply/View/Public/css/bootstrap.min.css" rel="stylesheet">
    <link href="/Addons/Apply/View/Public/css/font-awesome.min.css" rel="stylesheet">
    <link href="/Addons/Apply/View/Public/css/animate.css" rel="stylesheet">
    <link href="/Addons/Apply/View/Public/css/common.css" rel="stylesheet">
    <link href="/Addons/Apply/View/Public/css/sign.css" rel="stylesheet">

    <script type="text/javascript" src="/Addons/Apply/View/Public/js/jquery.min.js"></script>
    <script type="text/javascript" src="/Addons/Apply/View/Public/js/bootstrap.min.js"></script>
...
<div class="container container-fill">
    <div class="pcenter-main">
        <div class="head">
            <div class="pdetail">
                <div class="img-circle"><img src="<?php echo ($user["headimgurl"]); ?>"></div>
                <div class="pull-left">
    ...
    <div id="page_tag_load"><img src="/Addons/Apply/View/Public/image/ajax-loader.gif" alt="loader"></div>
    ...
    <div class="tc_c2" id="join_box"
        ...
        <div class="join_box_Xq_out" style="max-height: 641px;">
            <div class="tc_c_close">
                <div><img title="关闭" onclick="hidePop(this);" ontouchstart="" src="/Addons/Apply/View/Public/image/share_qr_close3.png"></div>
            </div>
            <div class="join_box_Xq">
                <ul id="ul_join_property" class="pop_massage">
                    ...
                    <li>
                        ...
                        <div class="inpoutK">
                            <input value="<?php echo ($contact["mobile"]); ?>" type="text" class="font0" name="mobile" id="mobile">
                        </div>
                    </li>
                    <li>
...
<script type="text/javascript">
    ...
    function submitOrder(){
        ...
        $.ajax({
            type: "post",
            url: "<?php echo u_addons('Apply://App/Index/addOrder');?>",
            data: {
                name: name,
                phone: phone,
                event: event,
