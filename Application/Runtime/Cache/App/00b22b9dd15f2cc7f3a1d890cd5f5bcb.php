...
<body class="back1">
		<div class="ads-tabs ovflw">
			...
			<a href="<?php echo U('App/Shop/orderList',array('sid'=>0,'type'=>1));?>" class="fl text-c "><span <?php if(($type) == "1"): ?>class='active'<?php endif; ?>>未支付</span></a>
			<a href="<?php echo U('App/Shop/orderList',array('sid'=>0,'type'=>2));?>" class="fl text-c"><span <?php if(($type) == "2"): ?>class='active'<?php endif; ?>>已支付</span></a>
			<a href="<?php echo U('App/Shop/orderList',array('sid'=>0,'type'=>3));?>" class="fl text-c"><span <?php if(($type) == "3"): ?>class='active'<?php endif; ?>>待出游</span></a>
		</div>
		<div class="ads-cc">
		<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="ads-lst border-b1 ovflw mr-b back2 color6">
				...
				<p class=" ads_ortt3 fonts85 ovflw border-b1">
				    <span class="fl">共<?php echo ($vo["totalnum"]); ?>件商品</span>
				    <span class="fr">实付：<em class="fonts18">￥<?php echo ($vo["payprice"]); ?></em></span>
				</p>
				<p class=" ads_ortt3 fonts85 ovflw">
				    <span class="fr">
				        <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('App/Shop/orderCancel',array('sid'=>0,'orderid'=>$vo['id']));?>" class="home-cz">取消订单</a><?php endif; ?>
