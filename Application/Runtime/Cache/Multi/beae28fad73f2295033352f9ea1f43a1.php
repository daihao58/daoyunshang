		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Multi/Shop/adsSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置广告">
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Multi/Shop/ads/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="商城广告" data-search="App-search">
...
<script type="text/javascript">
	...
	$('#App-delall').on('click',function(){
		...
		var toajax="<?php echo U('Multi/Shop/adsDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
