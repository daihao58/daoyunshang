            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-title">
                        <a href="<?php echo U('Multi/Normal/vipList/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="会员列表">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="score" disabled class="form-control" value="<?php echo ($cache["score"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">会员余额<sup>*</sup></label>
                        <div class="col-lg-4">
                            <input type="text" name="money" disabled class="form-control" value="<?php echo ($cache["money"]); ?>">
                        </div>
                    </div>
               <!--     <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">分销等级</label>
                        <div class="col-lg-4">
                            <select name="fx_level">
                                <option value="">请选择</option>
                                <?php if(is_array($vip_level_data)): $i = 0; $__LIST__ = $vip_level_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($cache['fx_level'] == $vo['id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-2 control-label">体验馆</label>
                        <div class="col-lg-4">
                            <select name="experience_hall">
                                <option value="0" <?php if($cache['experience_hall'] == 0): ?>selected<?php endif; ?> >未开</option>
                                <option value="1" <?php if($cache['experience_hall'] == 1): ?>selected<?php endif; ?> >已开</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">保证金金额</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="bond_money"  value="<?php echo ($cache["bond_money"]); ?>">
                        </div>
                    </div>
                    <!-- <div class="form-group">
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        ...
        $('#lid').val(lid);
        var tourl = "<?php echo U('Multi/Vip/vipSet');?>";
