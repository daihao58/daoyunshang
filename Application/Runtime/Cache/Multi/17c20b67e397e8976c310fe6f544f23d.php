     ...
     <div class="col-xs-12 col-xs-12">
          <div class="widget radius-bordered">
              <div class="widget-header bg-blue">
				...
				<span class="widget-caption">分组设置</span>
              ...
              <div class="widget-body">
                  ...
                  <div class="form-title">
                        <a href="<?php echo U('Multi/Shop/group/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="商城分组">
						<i class="fa fa-mail-reply"></i>返回
						</a>
                   </div>
                   <div class="form-group">
                        <label class="col-lg-2 control-label">分组名称<sup>*</sup></label>
                        <div class="col-lg-4">
                   ...
                   <!--</div>-->
                   <div class="form-group">
                        <label class="col-lg-2 control-label">分组商品<sup>*</sup></label>
                        <div class="col-lg-4">
                        <input type="text" class="form-control" name="goods" value="<?php echo ($cache["goods"]); ?>" placeholder="多个商品用','分割">
                        </div>
                   </div>
                   <div class="form-group">
                        <label class="col-lg-2 control-label">分组备注</label>
                        <div class="col-lg-4">
...
<script type="text/javascript">
	$('#AppForm').bootstrapValidator({
		submitHandler: function (validator, form, submitButton) {
           var tourl="<?php echo U('Multi/Shop/groupSet');?>";
