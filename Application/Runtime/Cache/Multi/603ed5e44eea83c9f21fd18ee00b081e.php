        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Multi/Shop/cateSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置分组">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="门店分组" data-search="App-search">
...
<td class=" "><?php echo ($vo["bpath"]); ?></td>
 -->
                                ...
                                <td class="center "><a href="<?php echo U('Multi/Shop/cateSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-content="确定删除该分类及其子分类？" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除</a>
                                    <!-- <?php if(empty($vo["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?> -->
                                </td>
                            </tr>
...
<!--                                     <td class=" "><?php echo ($vo2["pid"]); ?></td>
                                    ...
                                    <td class="center "><a href="<?php echo U('Multi/Shop/cateSet/',array('id'=>$vo2['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a>
                                        <?php if(empty($vo2["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo2['id']));?>"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?>
                                    </td>
                                </tr>
                                <?php if(is_array($vo2['_child'])): foreach($vo2['_child'] as $key=>$vo3): ?><tr id="item<?php echo ($vo3["id"]); ?>">
                                        ...
                                        <td class="center "><a href="<?php echo U('Multi/Shop/cateSet/',array('id'=>$vo3['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a>
                                            <?php if(empty($vo3["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo3['id']));?>"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php if(is_array($vo3['_child'])): foreach($vo3['_child'] as $key=>$vo4): ?><tr id="item<?php echo ($vo4["id"]); ?>">
                                            ...
                                            <td class="center "><a href="<?php echo U('Multi/Shop/cateSet/',array('id'=>$vo4['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a>
                                                <?php if(empty($vo4["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo4['id']));?>"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php if(is_array($vo4['_child'])): foreach($vo4['_child'] as $key=>$vo5): ?><tr id="item<?php echo ($vo5["id"]); ?>">
                                                ...
                                                <td class="center ">
                                                    <a href="<?php echo U('Multi/Shop/cateSet/',array('id'=>$vo5['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a>
                                                    <?php if(empty($vo5["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/cateDel/',array('id'=>$vo5['id']));?>"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?>
                                                </td>
