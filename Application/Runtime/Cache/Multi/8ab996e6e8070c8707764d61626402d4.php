        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Multi/Employee/achievement/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="返回">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Multi/Employee/vipAchievement',array('eid'=>$employee['id']));?>" class="btn btn-success" data-loader="App-loader" data-loadername="搜索" data-search="App-search">
