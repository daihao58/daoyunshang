...
<div class="row">
        ...
        <div class="widget radius-bordered">
            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">返利比例<sup>*</sup></label>
                        <div class="col-lg-2">
                            <div class="input-group input-group-xs">
                                <span class="input-group-btn">
                                    <button class="btn btn-darkorange" type="button">一级：</button>
                                </span>
                                <input name="fx1baifenbi" type="text" class="form-control" value="<?php echo ($cache["fx1baifenbi"]); ?>">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group input-group-xs">
                                ...
                                <input name="fx2baifenbi" type="text" class="form-control" value="<?php echo ($cache["fx2baifenbi"]); ?>">
                                <span class="baifenbi">%</span>
                            </div>
                        </div>
                     <!--   <div class="col-lg-2">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">挂靠补贴<sup>*</sup></label>
                        <div class="col-lg-2">
                            <div class="input-group input-group-xs">
                                <span class="input-group-btn">
                                    <button class="btn btn-darkorange" type="button">挂靠：</button>
                                </span>
                                <input name="gkbaifenbi" type="text" class="form-control" value="<?php echo ($cache["gkbaifenbi"]); ?>">
                                <span class="baifenbi">%</span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">首次购买奖励<sup>*</sup></label>
                        <div class="col-lg-2">
                            <div class="input-group input-group-xs">
                                <span class="input-group-btn">
                                    <button class="btn btn-darkorange" type="button">一级：</button>
                                </span>
                                <input name="first_one" type="text" class="form-control" value="<?php echo ($cache["first_one"]); ?>">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="input-group input-group-xs">
                                ...
                                <input name="first_two" type="text" class="form-control" value="<?php echo ($cache["first_two"]); ?>">
                            </div>
                        </div>
                    </div>
    ...
    $('#AppForm').bootstrapValidator({
        submitHandler: function(validator, form, submitButton) {
            var tourl = "<?php echo U('Multi/Shop/set');?>";
