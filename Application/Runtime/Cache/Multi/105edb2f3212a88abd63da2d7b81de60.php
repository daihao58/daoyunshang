		...
		<div class="widget">
			...
			<div class="widget-body">
 				...
 				<div class="row">
                    ...
                    <!-- form start -->
                    <!-- <form class="form-horizontal" action="<?php echo U('Multi/Trade/addTx');?>" method="post"> -->
				...
				<table id="App-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($txList)): $i = 0; $__LIST__ = $txList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class="">
                                    <?php if($vo["status"] == 0): ?><a  class="table-actions" data-loader="App-loader" data-loadername="取消提现" href="<?php echo U('Multi/Trade/updateTx',array('id'=>$vo['id'],'status' => -1));?>">取消</a><?php endif; ?>
                                </td>
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        var tourl = "<?php echo U('Multi/Trade/addTx');?>";
