                ...
                <div class="table-toolbar">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Multi/Vip/viplist/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="会员列表" data-search="App-search">
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <td class="center "><a href="<?php echo U('Multi/Vip/vipSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="会员编辑"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;
                                    ...
                                    <!-- &nbsp;&nbsp;<a href="<?php echo U('Multi/Vip/vipFxtj/',array('id'=>$vo['id']));?>" class="btn btn-darkorange btn-xs" target="_blank"><i class="fa fa-money"></i> 收益预估</a> -->
                                    <!--&nbsp;&nbsp;<a href="<?php echo U('Multi/vip/message/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Multi/vip/messageDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a>--></td>
...
$(btnpath).on('click', function() {
    ...
    $.ajax({
        ...
        url: "<?php echo U('Multi/Vip/vipTree');?>",
        async: false,
        dataType: 'json',
        success: function(e) {
            bootbox.dialog({
