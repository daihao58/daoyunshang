        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Multi/Employee/employeeSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置分组">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Multi/Employee/employeeList/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="管理员列表" data-search="App-search">
...
$('#App-delall').on('click', function() {
    ...
    var toajax = "<?php echo U('Multi/Employee/employeeDel');?>" + "/id/" + chk;
    var funok = function() {
        var callok = function() {
            //成功删除后刷新
...
function showQrcode(o) {
    var eid = $(o).data('id');
    var url = "<?php echo U('Multi/Employee/getqrcode');?>" + "/eid/" + eid;
    $("#qrcode")[0].src=url;
    $('#dialog').modal('show');
}
</script>
