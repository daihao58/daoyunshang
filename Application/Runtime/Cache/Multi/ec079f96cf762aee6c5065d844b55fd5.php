            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-title">
                        <a href="<?php echo U('Multi/Shop/goods/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="商品分组">
                ...
                <!--    <div class="form-group">
                   ...
                   <!-- <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" name="adpic" value="<?php echo ($cache["adpic"]); ?>" id="App-adpic" placeholder="尺寸：1200*1623px">
                                <span class="input-group-btn">
                                <button class="btn btn-default shiny" type="button" onclick="appImgviewer('App-adpic')"><i class="fa fa-camera-retro"></i>预览</button><button class="btn btn-default shiny" type="button" onclick="appImguploader('App-adpic',false)"><i class="glyphicon glyphicon-picture"></i>上传</button>
                            </span>
                            </div>
                        </div>
                    </div>-->
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">金牌会员返利价格<sup>*</sup></label>
                        <div class="col-lg-4">
                    ...
                    <!--<div class="form-group">-->
                        <!--<label class="col-lg-2 control-label">商品结算价<sup>*</sup></label>-->
                        <!--<div class="col-lg-4">-->
                            <!--<input type="text" class="form-control" name="cprice" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["cprice"]); ?>">-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="form-group">
                ...
                <!--    <div class="form-group">
                    ...
                    <!--<div class="form-group">-->
                    <!--    <label class="col-lg-2 control-label">开启每天返现功能</label>-->
                    <!--    <div class="col-lg-4">-->
                    <!--        <label>-->
                    <!--            <input type="hidden" name="cashback" value="<?php echo ($cache["cashback"]); ?>" id="cashback">-->
                    <!--            <input class="checkbox-slider slider-icon colored-darkorange" type="checkbox" id="cashbackbtn" <?php if(($cache["cashback"]) == "1"): ?>checked="checked"<?php endif; ?>>-->
                    <!--            <span class="text darkorange">&nbsp;&nbsp;&larr;重要：开启后可每天返现。</span>-->
                    <!--        </label>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--<div class="form-group" id="backratio">-->
                    <!--    <label class="col-lg-2 control-label">自定义返现比例</label>-->
                    <!--    <div class="col-lg-4">-->
                    <!--        <input type="text" class="form-control" name="backratio" placeholder="填写自定义销量，此销量也会自动增长" value="<?php echo ($cache["backratio"]); ?>">-->
                    <!--    </div>-->
                    <!--</div>-->
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        ...
        $('#lid').val(lid);
        var tourl = "<?php echo U('Multi/Shop/goodsSet');?>";
