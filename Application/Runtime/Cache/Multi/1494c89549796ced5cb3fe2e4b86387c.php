        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Multi/Shop/goodsSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置商品">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Multi/Shop/goods/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="商品" data-search="App-search">
                ...
                <table id="App-table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <td class=" ">
                                    <?php if(($vo["issku"]) == "1"): ?><a href="<?php echo U('Multi/Shop/sku/',array('id'=>$vo['id']));?>" class="btn btn-azure btn-xs" data-loader="App-loader" data-loadername="SKU管理"><i class="fa fa-edit"></i> 管理</a>
                                        <?php else: ?>未启用SKU<?php endif; ?>
                                </td>
                                <td class="center "><a href="<?php echo U('Multi/Shop/goodsSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置商品"><i class="fa fa-edit"></i> 管理</a>&nbsp;&nbsp;<button class="btn btn-success btn-xs getlink" data-id="<?php echo ($vo["id"]); ?>"><i class="fa fa-link"></i> 商品链接</button>&nbsp;&nbsp;<a href="<?php echo U('Multi/Shop/goods/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Multi/Shop/goodsDel/',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除</a></td>
...
$('#App-delall').on('click', function() {
    ...
    var toajax = "<?php echo U('Multi/Shop/goodsDel');?>" + "/id/" + chk;
    var funok = function() {
        var callok = function() {
            //成功删除后刷新
...
$('.status').on('click', function() {
    ...
    var toajax = "<?php echo U('Multi/Shop/goodsStatus');?>";
    var data = {
        'id': id,
        'status': status
    };
