	...
	<div class="col-xs-12 col-md-12">
		<div class="widget">
			<div class="widget-header bg-blue">
				...
				<span class="widget-caption">等级列表</span>
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Multi/Vip/levelSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="等级设置">
						<i class="fa fa-plus"></i>新增等级
					</a>
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Multi/Vip/level/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="等级列表" data-search="App-search">
...
<script type="text/javascript">
	...
	$('#App-delall').on('click',function(){
		...
		var toajax="<?php echo U('Multi/Vip/levelDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
