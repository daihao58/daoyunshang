...
<head>
    ...
    <!--时间-->
    <link rel="stylesheet" href="/Public/Admin/css/daterangepicker-bs3.css">
...
<body>
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <?php if(in_array(($sys), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--系统设置-->
                        <li>
                            ...
                            <ul class="submenu">
                                <!-- <li>
                                    <a href="<?php echo U('Multi/User/userList');?>" data-loader="App-loader" data-loadername="管理员管理">
                                        <span class="menu-text">系统管理员</span>
                                    </a>
                                </li> -->
                                <!-- <li>
                                    <a href="<?php echo U('Multi/Wx/set');?>" data-loader="App-loader" data-loadername="微信设置">
                                        <span class="menu-text">微信设置</span>
                                    </a>
                                </li> -->
                                <!-- <li>
                                    <a href="<?php echo U('Multi/Alipay/set');?>" data-loader="App-loader" data-loadername="支付宝设置">
                                        <span class="menu-text">支付宝设置</span>
                                    </a>
                                </li> -->
                               <!--  <li>
                                    <a href="<?php echo U('Multi/Sms/set');?>" data-loader="App-loader" data-loadername="短信宝设置">
                                        <span class="menu-text">短信宝设置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Wxprint/set');?>" data-loader="App-loader" data-loadername="微信打印机设置">
                                        <span class="menu-text">微信打印机设置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/set');?>" data-loader="App-loader" data-loadername="会员机制设置">
                                        <span class="menu-text">会员机制设置</span>
                                    </a>
                                </li> -->
								<!--
                                <li>
                                    <a href="<?php echo U('Multi/Vip/level');?>" data-loader="App-loader" data-loadername="会员等级设置">
                                        <span class="menu-text">会员等级设置</span>
                                    </a>
                                </li>
								-->
                                <li>
                                    <a id="AppHome" href="<?php echo U('Multi/Shop/set');?>" data-loader="App-loader" data-loadername="商城设置">
                                        <span class="menu-text">商城设置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/level');?>" data-loader="App-loader" data-loadername="等级设置">
                                        <span class="menu-text">等级设置</span>
                                    </a>
                                </li>
                            </ul>
                        </li><?php endif; ?>
                    <?php if(in_array(($wx), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--微信管理-->
                       <!--  <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Wx/keyword');?>" data-loader="App-loader" data-loadername="魔法关键词">
                                        <span class="menu-text">魔法关键词</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Wx/menu');?>" data-loader="App-loader" data-loadername="自定义菜单">
                                        <span class="menu-text">魔法菜单栏</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Wx/qrcodeBgSet');?>" data-loader="App-loader" data-loadername="二维码背景设置">
                                        <span class="menu-text">推广二维码</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Wx/customer');?>" data-loader="App-loader" data-loadername="客服消息">
                                        <span class="menu-text">客服消息配置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Wx/template');?>" data-loader="App-loader" data-loadername="模版消息">
                    ...
                    <?php if(in_array(($shop), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--商城设置-->
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Shop/ads');?>" data-loader="App-loader" data-loadername="广告管理">
                                        <span class="menu-text">广告管理</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Shop/cate');?>" data-loader="App-loader" data-loadername="商城分类">
                      ...
                      <!--          <li>
                                    <a href="<?php echo U('Multi/Shop/label');?>" data-loader="App-loader" data-loadername="标签管理">
                                        <span class="menu-text">标签管理</span>
                                    </a>
                                </li>-->
                                <li>
                                    <a href="<?php echo U('Multi/Shop/goods');?>" data-loader="App-loader" data-loadername="商品管理">
                    ...
                    <?php if(in_array(($card), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--  <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Vip/card',array('type'=>'1'));?>" data-loader="App-loader" data-loadername="卡券列表-充值卡">
                                        <i class="glyphicon glyphicon-credit-card"></i>
                                        <span class="menu-text">充值卡</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/card',array('type'=>'2'));?>" data-loader="App-loader" data-loadername="卡券列表-代金券">
                    ...
                    <?php if(in_array(($tree), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--层级树-->
                        <li>
                            <a href="<?php echo U('Multi/Vip/vipTrack');?>" data-loader="App-loader" data-loadername="层级树">
                    ...
                    <?php if(in_array(($normal), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--普通用户会员中心-->
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Normal/vipList');?>" data-loader="App-loader" data-loadername="会员列表">
                        ...
                        <li>
                            <a href="<?php echo U('Multi/Vip/message');?>" data-loader="App-loader" data-loadername="通知中心">
                    ...
                    <?php if(in_array(($vip), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--会员中心-->
                        <!-- <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Vip/vipRebornList');?>" data-loader="App-loader" data-loadername="可调配会员">
                                        <span class="menu-text">可调配会员中心</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/vipAllocList');?>" data-loader="App-loader" data-loadername="未分配员工 一级会员列表">
                                        <span class="menu-text">会员分配中心</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/vipList');?>" data-loader="App-loader" data-loadername="会员列表">
                                        <span class="menu-text">会员列表</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <?php if(in_array(($withdraw), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                          <!--      <li>
                                    <a href="<?php echo U('Multi/Trade/tx');?>" data-loader="App-loader" data-loadername="商家-财务管理">
                                ...
                                <li>
                                    <a href="<?php echo U('Multi/Vip/txorder',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="挂靠申请列表-未通过">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">挂靠申请</span>
                                    </a>
                                </li>

                                 <li>
                                    <a href="<?php echo U('Multi/Vip/txorder',array('status'=>'1'));?>" data-loader="App-loader" data-loadername="挂靠申请列表-已通过">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">已通过的申请</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="<?php echo U('Multi/Vip/recharge');?>" data-loader="App-loader" data-loadername="现金币充值">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">现金币充值</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="<?php echo U('Multi/Vip/recharge_info');?>" data-loader="App-loader" data-loadername="充值明细">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">充值明细</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="<?php echo U('Multi/Vip/bond');?>" data-loader="App-loader" data-loadername="保证金">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">保证金明细</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Vip/rebateinfo');?>" data-loader="App-loader" data-loadername="返利明细">
                                        <i class="glyphicon glyphicon-usd"></i>
                                ...
                                <!-- <li>
                                 ...
                                 <li>
                                     <a href="<?php echo U('Multi/Vip/txorder',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="提现订单管理-提现取消">
                                         <i class="glyphicon glyphicon-remove"></i>
                                         <span class="menu-text">提现取消</span>
                                     </a>
                                 </li>
                                 <li>
                                     <a href="<?php echo U('Multi/Vip/cashback',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="商品返现管理-返现">
                                         <i class="glyphicon glyphicon-ok"></i>
                                         <span class="menu-text">返现管理</span>
                                     </a>
                                 </li>   -->
                            </ul>
                        </li><?php endif; ?>
                    <?php if(in_array(($order), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Shop/orderReport');?>" data-loader="App-loader" data-loadername="当天订单报表">
                                        <i class="glyphicon glyphicon-paperclip"></i>
                                        <span class="menu-text">当天订单报表</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>9));?>" data-loader="App-loader" data-loadername="订单管理-当天购买记录">
                                        <i class="glyphicon glyphicon-paperclip"></i>
                                        <span class="menu-text">当天订单记录</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order');?>" data-loader="App-loader" data-loadername="订单管理-全部订单">
                                ...
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>'3'));?>" data-loader="App-loader" data-loadername="订单管理-已发货订单">
                                ...
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>'7'));?>" data-loader="App-loader" data-loadername="订单管理-退货完成">
                                ...
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>'6'));?>" data-loader="App-loader" data-loadername="订单管理-交易关闭">
                                        <i class="glyphicon glyphicon-remove"></i>
                                        <span class="menu-text">交易关闭</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="订单管理-交易取消">
                                        <i class="glyphicon glyphicon-trash"></i>
                                        <span class="menu-text">交易取消</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Shop/order',array('status'=>'8'));?>" data-loader="App-loader" data-loadername="订单管理-满7天订单">
                                        <i class="glyphicon glyphicon-ok"></i>
                    ...
                    <?php if(in_array(($log), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--  <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Log/vip');?>" data-loader="App-loader" data-loadername="会员日志">
                                        <span class="menu-text">会员日志</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Log/order');?>" data-loader="App-loader" data-loadername="订单日志">
                                        <span class="menu-text">订单日志</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Log/fx');?>" data-loader="App-loader" data-loadername="分销日志">
                                        <span class="menu-text">分销日志</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Log/tj');?>" data-loader="App-loader" data-loadername="推广日志">
                    ...
                    <?php if(in_array(($artical), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Artical/index');?>" data-loader="App-loader" data-loadername="文章管理">
                                        <span class="menu-text">文章管理</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Artical/add');?>" data-loader="App-loader" data-loadername="添加/修改文章">
                    ...
                    <!-- <?php if(in_array(($addon), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Addons/index');?>" data-loader="App-loader" data-loadername="插件管理">
                                        <span class="menu-text">插件管理</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Mail/index');?>" data-loader="App-loader" data-loadername="邮件设置">
                                        <span class="menu-text">邮件设置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Card/index');?>" data-loader="App-loader" data-loadername="会员卡设置">
                                        <span class="menu-text">会员卡设置</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Coupon/index');?>" data-loader="App-loader" data-loadername="微信卡券核销">
                    ...
                    <!-- <?php if(in_array(($score), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Multi/Score/order');?>" data-loader="App-loader" data-loadername="积分订单管理">
                                        <span class="menu-text">积分订单管理</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Score/index');?>" data-loader="App-loader" data-loadername="积分商品管理">
                                        <span class="menu-text">积分商品管理</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Multi/Score/add');?>" data-loader="App-loader" data-loadername="添加/修改积分商品">
                    ...
                    <!-- <?php if(!in_array(($employee), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            <a href="<?php echo U('Multi/Index/help');?>" data-loader="App-loader" data-loadername="帮助中心">
                                <i class="menu-icon glyphicon glyphicon-book"></i>
                    ...
                    <?php if(in_array(($employee), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                <li>
                                    ...
                                    <ul class="submenu">
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/vipCenter');?>" data-loader="App-loader" data-loadername="我的会员列表">
                                ...
                                <li>
                                    ...
                                    <ul class="submenu">
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>9));?>" data-loader="App-loader" data-loadername="订单管理-当天购买记录">
                                                <i class="glyphicon glyphicon-paperclip"></i>
                                                <span class="menu-text">当天订单记录</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter');?>" data-loader="App-loader" data-loadername="订单管理-全部订单">
                                                <i class="glyphicon glyphicon-asterisk"></i>
                                                <span class="menu-text">全部</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'1'));?>" data-loader="App-loader" data-loadername="订单管理-未支付订单">
                                                <i class="glyphicon glyphicon-heart-empty"></i>
                                                <span class="menu-text">未付款</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'2'));?>" data-loader="App-loader" data-loadername="订单管理-已支付订单">
                                                <i class="glyphicon glyphicon-usd"></i>
                                                <span class="menu-text">已付款</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'3'));?>" data-loader="App-loader" data-loadername="订单管理-已发货订单">
                                                <i class="glyphicon glyphicon-export"></i>
                                                <span class="menu-text">已发货</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'4'));?>" data-loader="App-loader" data-loadername="订单管理-退货中订单">
                                                <i class="glyphicon glyphicon-import"></i>
                                                <span class="menu-text">退货中</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'7'));?>" data-loader="App-loader" data-loadername="订单管理-退货完成">
                                                <i class="glyphicon glyphicon-saved"></i>
                                                <span class="menu-text">退货完成</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'5'));?>" data-loader="App-loader" data-loadername="订单管理-交易完成">
                                                <i class="glyphicon glyphicon-ok"></i>
                                                <span class="menu-text">交易完成</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'6'));?>" data-loader="App-loader" data-loadername="订单管理-交易关闭">
                                                <i class="glyphicon glyphicon-remove"></i>
                                                <span class="menu-text">交易关闭</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="订单管理-交易取消">
                                                <i class="glyphicon glyphicon-trash"></i>
                                                <span class="menu-text">交易取消</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo U('Multi/Employee/orderCenter',array('status'=>'8'));?>" data-loader="App-loader" data-loadername="订单管理-满7天订单">
                                                <i class="glyphicon glyphicon-ok"></i>
                                                <span class="menu-text">满7天</span>
                                            </a>
                                        </li>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb" id="App-bread">
                        <li>
							...
							<?php if(in_array(($employee), is_array($useroath)?$useroath:explode(',',$useroath))): ?><a href="<?php echo U('Multi/Shop/set');?>" data-loader="App-loader" data-loadername="商城设置">商城设置</a><?php endif; ?>
                        </li>
                ...
                <div class="page-header position-relative">
                    ...
                    <div class="header-buttons">
                        ...
                        <a class="refresh" id="refresh-toggler" href="<?php echo U('Multi/Shop/set');?>" data-loader="App-loader" data-name="主控面板">
    ...
    <!--百度地图类库-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=gk88uOKbmZEuMGEgEFkEvKGz"></script>
    <!--App全局API-->
    ...
    function appSkuloader(ids, fbid) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo U('Multi/Shop/skuLoader');?>",
            data: {
                'ids': ids,
                'fbid': fbid
            },
