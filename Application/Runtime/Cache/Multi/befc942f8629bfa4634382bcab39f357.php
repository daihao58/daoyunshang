		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Multi/Vip/messageSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="会员消息">
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Multi/Vip/message/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="会员消息" data-search="App-search">
...
<script type="text/javascript">
	...
	$('#App-delall').on('click',function(){
		...
		var toajax="<?php echo U('Multi/Vip/messageDel');?>"+"/id/"+chk;
		var funok=function(){
			var callok=function(){
				//成功删除后刷新
