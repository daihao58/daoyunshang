	...
	<div class="col-xs-12 col-md-12">
		<div class="widget">
			<div class="widget-header bg-blue">
				...
				<span class="widget-caption">挂靠申请</span>
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<?php if(($status) == "1"): ?><a id="App-txok" href="#" class="btn btn-success">
						<i class="fa fa-delicious"></i>批量完成申请
					</a><?php endif; ?>
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Multi/Vip/txorder/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="挂靠申请" data-search="App-search">
				...
				<table id="App-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class=" "><?php echo ($vo["aid"]); ?></td>
								<td class=" "><?php echo ($vo["aname"]); ?></td>
								<td class=" "><?php echo ($vo["amobile"]); ?></td>
								<td class=" "><?php echo ($vo["bid"]); ?></td>
								<td class=" "><?php echo ($vo["bname"]); ?></td>
