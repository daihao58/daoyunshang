		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Multi/Shop/skuattrSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置分组">
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Multi/Shop/skuattr/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="SKU属性" data-search="App-search">
...
<script type="text/javascript">
	...
	$('#App-delall').on('click',function(){
		...
		var toajax="<?php echo U('Multi/Shop/skuattrDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
