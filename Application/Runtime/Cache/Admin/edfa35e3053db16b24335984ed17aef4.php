                ...
                <ul class="nav sidebar-menu">
                    ...
                    <?php if(in_array(($sys), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--系统设置-->
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="<?php echo U('Admin/Sms/index');?>" data-loader="App-loader" data-loadername="短信模版">
                                        <span class="menu-text">短信模版</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Sms/phone_index');?>" data-loader="App-loader" data-loadername="短信记录">
                                        <span class="menu-text">短信记录</span>
                                    </a>
                                </li>
                                <!-- <li>
                    ...
                    <?php if(in_array(($shop), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--商城设置-->
                        <li>
                            ...
                            <ul class="submenu">
                                 <li>
                                    <a href="<?php echo U('Admin/Shop/mall');?>" data-loader="App-loader" data-loadername="广告管理">
                    ...
                    <?php if(in_array(($withdraw), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                            ...
                            <ul class="submenu">
                                 <li>
                                    <a href="<?php echo U('Admin/Vip/txorder',array('status'=>'1'));?>" data-loader="App-loader" data-loadername="银行卡提现订单管理-新订单">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">银行卡提现申请</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Vip/txorder',array('status'=>'2'));?>" data-loader="App-loader" data-loadername="银行卡提现订单管理-提现完成">
                                        <i class="glyphicon glyphicon-ok"></i>
                                        <span class="menu-text">银行卡提现完成</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Vip/txorder',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="银行卡提现订单管理-提现取消">
                                        <i class="glyphicon glyphicon-remove"></i>
                                        <span class="menu-text">银行卡提现取消</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Wxhongbao/wxtxorder');?>" data-loader="App-loader" data-loadername="微信红包提现订单管理-新订单">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">vip微信红包提现</span>
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="<?php echo U('Admin/Vip/cashback',array('status'=>'0'));?>" data-loader="App-loader" data-loadername="商品返现管理-返现">
                                        <i class="glyphicon glyphicon-ok"></i>
                                        <span class="menu-text">vip返现管理</span>
                                    </a>
                                </li> -->
                                <li>
                                    <a href="<?php echo U('Admin/Trade/tx');?>" data-loader="App-loader" data-loadername="商家-财务管理">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">商家提现管理</span>
                                    </a>
                                </li>                                
                            </ul>
                        </li><?php endif; ?>
                            ...
                            <ul class="submenu">
                                <li>
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            <a href="<?php echo U('Admin/Employee/tuijianma');?>" data-loader="App-loader" data-loadername="我的个人信息">
                                                <span class="menu-text">我的个人信息</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
