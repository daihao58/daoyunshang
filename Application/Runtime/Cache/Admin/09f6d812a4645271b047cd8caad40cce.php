            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-title">
                        <a href="<?php echo U('Admin/Employee/employeeList/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="管理员管理">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="nickname" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["nickname"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">员工登陆名<sup>*</sup></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="username" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["username"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
