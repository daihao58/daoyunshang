                ...
                <table id="App-table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                <td class=" sorting_1"><?php echo ($vo["shop_id"]); ?></td>
...
<td class=" "><?php echo ($vo["bpath"]); ?></td>
 -->
                                ...
                                <td class="center ">
                                    <!--<a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组">-->
                                    <!--    <i class="fa fa-edit"></i> 编辑-->
                                    <!--</a>&nbsp;&nbsp;-->
                                    <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-content="确定删除该分类及其子分类？" data-ajax="<?php echo U('Admin/Shop/cateDel/',array('id'=>$vo['id']));?>">
                            ...
                            <?php if(is_array($vo['_child'])): $i = 0; $__LIST__ = $vo['_child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo2["id"]); ?>">
                                    <td class=" sorting_1"><?php echo ($vo2["shop_id"]); ?></td>
<!--                                     <td class=" "><?php echo ($vo2["pid"]); ?></td>
                                    ...
                                    <td class="center ">
                                        <!--<a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo2['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组">-->
                                        <!--    <i class="fa fa-edit"></i> 编辑-->
                                        <!--</a>-->
                                        <?php if(empty($vo2["soncate"])): ?>&nbsp;&nbsp;
                                            <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Admin/Shop/cateDel/',array('id'=>$vo2['id']));?>">
                                                <i class="fa fa-trash-o"></i> 删除
                                            </a><?php endif; ?>
                                    </td>
                                </tr>
                                <?php if(is_array($vo2['_child'])): foreach($vo2['_child'] as $key=>$vo3): ?><tr id="item<?php echo ($vo3["id"]); ?>">
                                        <td class=" sorting_1"><?php echo ($vo3["shop_id"]); ?></td>
                                        ...
                                        <td class="center ">
                                            <!--<a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo3['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组">-->
                                            <!--    <i class="fa fa-edit"></i> 编辑-->
                                            <!--</a>-->
                                            <?php if(empty($vo3["soncate"])): ?>&nbsp;&nbsp;
                                                <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Admin/Shop/cateDel/',array('id'=>$vo3['id']));?>">
                                                    <i class="fa fa-trash-o"></i> 删除
                                                </a><?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php if(is_array($vo3['_child'])): foreach($vo3['_child'] as $key=>$vo4): ?><tr id="item<?php echo ($vo4["id"]); ?>">
                                            ...
                                            <td class=" sorting_1"><?php echo ($vo4["shop_id"]); ?></td>
                                            ...
                                            <td class="center ">
                                                <!--<a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo4['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组">-->
                                                <!--    <i class="fa fa-edit"></i> 编辑-->
                                                <!--</a>-->
                                                <?php if(empty($vo4["soncate"])): ?>&nbsp;&nbsp;
                                                    <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Admin/Shop/cateDel/',array('id'=>$vo4['id']));?>">
                                                        <i class="fa fa-trash-o"></i> 删除
                                                    </a><?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php if(is_array($vo4['_child'])): foreach($vo4['_child'] as $key=>$vo5): ?><tr id="item<?php echo ($vo5["id"]); ?>">
                                                ...
                                                <td class=" sorting_1"><?php echo ($vo5["shop_id"]); ?></td>
                                                ...
                                                <td class="center ">
                                                    <!--<a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo5['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分组">-->
                                                    <!--    <i class="fa fa-edit"></i> 编辑-->
                                                    <!--</a>-->
                                                    <?php if(empty($vo5["soncate"])): ?>&nbsp;&nbsp;
                                                        <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Admin/Shop/cateDel/',array('id'=>$vo5['id']));?>">
                                                            <i class="fa fa-trash-o"></i> 删除
                                                        </a><?php endif; ?>
                                                </td>
