...
return array(
    ...
    /* 数据库设置 */
    'DB_TYPE' => 'mysql', // 数据库类型
    'DB_HOST' => '47.98.144.121', // 服务器地址
    'DB_NAME' => 'daoyunshang', // 数据库名
    'DB_USER' => 'root', // 用户名
    'DB_PWD' => 'daoyunshang', // 密码
    'DB_PORT' => '3306', // 端口
    'DB_PREFIX' => 'wfx_', // 数据库表前缀

/*    'DB_TYPE' => 'mysql', // 鏁版嵁搴撶被鍨?
    'DB_HOST' => '127.0.0.1', // 鏈嶅姟鍣ㄥ湴鍧€
    'DB_NAME' => 'testdh', // 鏁版嵁搴撳悕
    'DB_USER' => 'root', // 鐢ㄦ埛鍚?
    'DB_PWD' => '', // 瀵嗙爜
//    'DB_PWD' => 'root@www.uu1.com!@#$%', // 瀵嗙爜
    'DB_PORT' => '3306', // 绔彛
    'DB_PREFIX' => 'wfx_', // 鏁版嵁搴撹〃鍓嶇紑*/
