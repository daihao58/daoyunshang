...
class ShopController extends BaseController
{
    ...
    public function cate()
    {
        ...
        //AppTree快速无限分类
        $field = array("id", "shop_id","pid", "lv", "name", "summary", "soncate", "sorts", "concat(path,'-',id) as bpath");
    ...
    public function mall()
    {
        ...
        $count = $m->where($map)->count();
        $this->getPage($count, $psize, 'App-loader', '店铺管理', 'App-search');
        $this->assign('cache', $cache);
        // dump($cache);
        $this->display();
    }
    ...
    public function mallChecked1()
    {
        ...
        $data["status"] = "1";
        $re = $m->where(array("id" => array("in", $id)))->save($data);
        $info['status'] = 1;
        $info['msg'] = '操作成功!';
        $this->ajaxReturn($info);      
    }
    public function mallChecked()
    {
